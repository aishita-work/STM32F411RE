...
/*This code is for single coversion driver , that after each conversion , we need to start conversion again.
 * This is good for when you just want to sample once .*/
